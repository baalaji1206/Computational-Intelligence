...
def knn(X_train, y_train, X_test, k):
    ...
    for test_point in X_test:
        ...
        distances_file.write(f"Distances: {str(distances)}\n")
        ...
        result_file.write(f"Class 0: {most_common[0][0]} Neighbours\tClass 1: {most_common[0][1]} Neighbours\t")
        result_file.write(f"Prediction: Class {prediction}\n")
